    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <?php endif; ?>
                <form action="proses.login.php?<?= isset($_GET['id']) ? ('id=' . $_GET['id']) : '' ?>" method="post">
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col-8">
                            <a href="register.php?<?= isset($_GET['id']) ? ('id=' . $_GET['id']) : '' ?>" class="text-center">Register a new account</a>
                        </div>
                        <!-- /.col -->
                        <div class="col-4">
